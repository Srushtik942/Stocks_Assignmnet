...
//sort stocks by pricing

function sortStocksByPricing(stock1, stock2, price) {
...
app.get('/stocks/sort/pricing', (req, res) => {
  ...
  stocksCopy.sort(sortStocksByPricing);
  res.json(stocksCopy);
});

// sort stocks by growth

function stockGrowth(stock1, stock2, growth) {
...
app.get('/stocks/sort/growth', (req, res) => {
  ...
  let stocksCopy = stocks.slice();
  stocksCopy.sort(stockGrowth, growth);
  res.json(stocksCopy);
});

//  Filter the stocks based on the 2 Stock Exchange
